...
public class MapActivityMy extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mapmy_layout);
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.mapAPIMy);
        mapFragment.getMapAsync(this);
        mapView = mapFragment.getView();

        mFusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(MapActivityMy.this);
        Places.initialize(MapActivityMy.this, "AIzaSyCbYHv_Ciqc__V2wTq_PwNf9_vWNuq5tH0");
    ...
    private void InputToVar() {
        btnFind = findViewById(R.id.mapButAPIMy);
    }
    ...
    private void ButtonVoltar() {
        ...
        buttonV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MapActivityMy.this, PerfilActivity.class)
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (mapView != null && mapView.findViewById(Integer.parseInt("1")) != null) {
            ...
            SettingsClient settingsClient = LocationServices.getSettingsClient(MapActivityMy.this);
            Task<LocationSettingsResponse> task = settingsClient.checkLocationSettings(builder.build());

            task.addOnSuccessListener(MapActivityMy.this, new OnSuccessListener<LocationSettingsResponse>() {
                @Override
                public void onSuccess(LocationSettingsResponse locationSettingsResponse) {
                    getDeviceLocation();
                }
            });
            task.addOnFailureListener(MapActivityMy.this, new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    if (e instanceof ResolvableApiException) {
                        ResolvableApiException resolvable = (ResolvableApiException) e;
                        try {
                            resolvable.startResolutionForResult(MapActivityMy.this, 51);
                ...
                .addOnCompleteListener(new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(MapActivityMy.this, "Unable to get last location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    private void AlertMessage() {
        ...
        builder.setNegativeButton("Voltar", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(MapActivityMy.this, CadAnimal.class));
                finish();
            }
        });
        builder.create().show();
